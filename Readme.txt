Name and Description
    ...
    Videocache  is  a  Squid  url  rewriter  plugin written in Python to facilitate caching youtube, metacafe, dailymotion, google, vimeo, redtube, xtube,
    youporn, msn soapbox, tube8, blip.tv, break.com and wrzuta.pl videos. It can cache videos from various websites in a separate  directory  (other  than
    Squid  cache), in a browsable fashion and can serve the subsequent requests from the cache. It helps in saving bandwidth and reducing load time of the
