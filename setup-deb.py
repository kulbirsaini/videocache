...
if __name__ == '__main__':
    ...
    parser.add_option('-a', '--apache-dir', dest = 'apache_dir', type='string', help = 'Path to conf.d directory for Apache. Default is /etc/apache2/conf.d/', default = '/etc/apache2/conf.d/')
