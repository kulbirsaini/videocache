...
Version:    1.9.8
Release:    1
Summary:    Videocache is a squid url rewriter plugin to cache Youtube, Facebook, Metacafe, Dailymotion, Google, Vimeo, Xhamster, Redtube, Xtube, Youporn, MSN Soapbox, Tube8, Blip TV, Break.com and Wrzuta.pl videos.
...
%description
Videocache is a squid url rewriter plugin written in Python to facilitate youtube, facebook, metacafe, dailymotion, google, vimeo, xhamster, redtube, xtube, youporn, msn soapbox, tube8, blip.tv, break.com and wrzuta.pl video caching. It can cache videos from various websites in a separate directory (other than squid cache directory) in a browsable fashion and can serve the subsequentrequests from the cache. It helps in saving bandwidth and reducing loading time.
