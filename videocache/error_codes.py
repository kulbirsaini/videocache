...
STORE_LOG_HIT_CONFIRMED = 'STORE_LOG_HIT_CONFIRMED'
STORE_LOG_HIT_CONFIRMATION_FAILED = 'STORE_LOG_HIT_CONFIRMATION_FAILED'
...
FILEDB_CONNECT_ERR = 'FILEDB_CONNECT_ERR'
FILEDB_WRITE = 'FILEDB_WRITE'
FILEDB_ERR = 'FILEDB_ERR'
QUEUE_SUBMIT_FAIL = 'QUEUE_SUBMIT_FAIL'
DB_QUERY_ERR = 'DB_QUERY_ERR'
ACCESS_LOG_WATCH_START = 'ACCESS_LOG_WATCH_START'
ACCESS_LOG_NOT_MONITORED = 'ACCESS_LOG_NOT_MONITORED'
ACCESS_LOG_NOT_FOUND = 'ACCESS_LOG_NOT_FOUND'
ACCESS_LOG_READ_ERR = 'ACCESS_LOG_READ_ERR'
ACCESS_LOG_PARSE_ERR = 'ACCESS_LOG_PARSE_ERR'
