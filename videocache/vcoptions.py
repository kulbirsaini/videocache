...
class VideocacheOptions:
    ...
    def __init__(self, config_file = '/etc/videocache.conf', root = '/'):
        ...
        self.root = root
        self.websites = ['youtube', 'facebook', 'metacafe', 'dailymotion', 'cnn', 'aol', 'myspace', 'xhamster', 'xvideos', 'pornhub', 'redtube', 'xtube', 'vimeo', 'wrzuta', 'youporn', 'bing', 'tube8', 'bliptv', 'break']
